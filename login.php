...
<html lang="pt-br">
  ...
  <body>
    ...
    <div class="form-center">
        ...
        <form class="form-login" method="post" action="php/valida.php">

            <div class="text-center mb-4">

                <img class="mb-4 rounded-circle" src="img/login-bg.png" alt="" width="100" height="72">
                <h1 class="h3 mb-3 font-weight-normal">Login painel</h1>
                ...
                <button class="btn btn-lg btn-secondary btn-block" type="submit" name="entrar">Entrar</button>
                <a href="cadastro.php" class="btn btn-lg btn-danger btn-block" type="submit" name="entrar" >Cadastro</a>
